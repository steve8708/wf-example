...
const products: Product[] = [
  {
    ...
    price: "$31.99",
    image: "https://assets.wfcdn.com/im/37595259/resize-h400-w400%5Ecompr-r85/2773/277331061/Yee+to+the+Haw+Rodeo+Skeleton.jpg"
  },
  {
    id: "2", 
    ...
    price: "$30.00",
    originalPrice: "$39.99",
    image: "https://assets.wfcdn.com/im/59776279/resize-h400-w400%5Ecompr-r85/3043/304313716/Jessica+Simpson+Plush+Throw+Blanket.jpg"
  },
  {
    id: "3",
    ...
    openBoxPrice: "$30.40",
    hasVerified: true,
    image: "https://assets.wfcdn.com/im/40143060/resize-h400-w400%5Ecompr-r85/3242/324207755/Amalfi+Boucle+Throw+Pillow.jpg"
  },
  {
    id: "4",
    title: "Sunglasses For All II",
    price: "$29.99", 
    image: "https://assets.wfcdn.com/im/76906249/resize-h400-w400%5Ecompr-r85/2584/258418446/%22+Sunglasses+For+All+II+%22.jpg"
  },
  {
    id: "5",
    ...
    openBoxPrice: "$25.15",
    hasSale: true,
    image: "https://assets.wfcdn.com/im/76429920/resize-h400-w400%5Ecompr-r85/2616/261607777/Camden+Chambray+Cozy+Comforter+Set.jpg"
  },
  {
    id: "6",
    title: "Iron Over-the-Door 5 - Hook Coat Rack",
    price: "$19.99",
    image: "https://assets.wfcdn.com/im/47156621/resize-h400-w400%5Ecompr-r85/1273/127377232/Iron+Over-the-Door+5+-+Hook+Coat+Rack.jpg"
  },
  {
    id: "7", 
    ...
    image: "https://assets.wfcdn.com/im/85628237/resize-h400-w400%5Ecompr-r85/2603/260352228/Tommy+Bahama+Printed+Percale+Cotton+Sheet+Set.jpg"
  }
];
    ...
    <section className="bg-white py-8">
      <div className="max-w-[1600px] mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-6 px-2">
          ...
          <Button variant="link" className="text-[#7B189F] font-medium underline">
            See all
          </Button>
        </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {product.openBoxPrice && (
                      <div className="text-sm text-red-600">
                        <span>Open Box: </span>
                        <span className="font-medium">{product.openBoxPrice}</span>
                      </div>
                    )}
                  </div>
                </div>
